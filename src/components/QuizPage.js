...
function QuizPage() {
    ...
    else if (location.state === "geography") currentQuestions = geographyQuestions;
    ...
    return (
        <div>
            ...
            <div id="quizPageButtons">
                ...
                <button onClick={() => handleAnswerClick(3)}>{currentQuestions[currentIndex].variant3}</button>
                <button onClick={() => handleAnswerClick(4)}>{currentQuestions[currentIndex].variant4}</button>
            </div>
        </div>
    );
}
